...
# A modified config of mobilenet v2 that extracts denser feature maps
def _create_modified_mobilenet_config():
  conv_defs = copy.deepcopy(mobilenet_v2.V2_DEF)
  conv_defs['spec'][7] = mobilenet.op(conv_blocks.expanded_conv, stride=1, num_outputs=64)
  return conv_defs


class SSDMobileNetV2DenseFeatureExtractor(ssd_meta_arch.SSDFeatureExtractor):
  ...
  def __init__(self,
    ...
    Args:
      ...
      override_base_feature_extractor_hyperparams: Whether to override
        ...
        `conv_hyperparams_fn`.
    """
    super(SSDMobileNetV2DenseFeatureExtractor, self).__init__(
